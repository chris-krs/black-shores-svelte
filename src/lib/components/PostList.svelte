    ...
    >
      <div class="p-4 flx-col justify-center">
        <a
          ...
          class="group font-bold text-lg flex items-center hover:(text-blue transition-colors duration-300)"
        >
          <div class="w-1 h-6 rounded-full mr-2 bg-blue-500"></div>
          <span class="text-xl">{post.title}</span>
          <i class="group-hover:opacity-100 opacity-0  i-iuno-right text-blue-500 w-6 h-6"></i>
        </a>
